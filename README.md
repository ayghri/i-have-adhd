...
10 rules. On installs that load the full skill file, they're applied through one of four response modes (compact / normal / deep / audit) chosen by task type; standalone copy/paste prompts (e.g. Gemini) don't carry the modes yet. Full text in [SKILL.md](./skills/i-have-adhd/SKILL.md).
