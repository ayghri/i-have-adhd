...
| Claude, Codex, and Qoder metadata | `.claude-plugin/`, `.codex-plugin/`, `.qoder-plugin/`, `.agents/plugins/` | Plugin manifests and marketplace metadata. |
...
| Qoder | `.qoder-plugin/plugin.json`, `skills/i-have-adhd/SKILL.md`, `scripts/package_qoder_plugin.py` |
