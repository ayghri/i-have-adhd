...
1. Download the [canonical SKILL.md](https://raw.githubusercontent.com/aixinwudi/i-have-adhd-cn/main/skills/i-have-adhd/SKILL.md) and save it as `SKILL.md`. Review its contents before uploading.
...
```bash
npx skills add aixinwudi/i-have-adhd-cn -a github-copilot        # this project
npx skills add aixinwudi/i-have-adhd-cn -a github-copilot -g     # all projects
```
...
Copilot respects `disable-model-invocation`: nothing applies until you invoke the skill, same as Claude Code (tested in [#60](https://github.com/aixinwudi/i-have-adhd-cn/pull/60)).
...
Or remove the tap too: `hermes skills tap remove aixinwudi/i-have-adhd-cn`.
...
1. Run `/plugins`.
2. Choose **Custom**.
3. Paste `https://github.com/aixinwudi/i-have-adhd-cn` and press `Enter`.
...
```bash
npx skills add aixinwudi/i-have-adhd-cn                  # this workspace
npx skills add aixinwudi/i-have-adhd-cn -g               # all projects
npx skills add aixinwudi/i-have-adhd-cn -a cursor -y     # one agent only
