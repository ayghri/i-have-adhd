...
```bash
npx skills add aixinwudi/i-have-adhd-cn -a github-copilot        # dự án này
npx skills add aixinwudi/i-have-adhd-cn -a github-copilot -g     # mọi dự án
```
...
Copilot tuân theo `disable-model-invocation`: không có gì được áp dụng cho đến khi bạn gọi skill, giống Claude Code (đã kiểm thử trong [#60](https://github.com/aixinwudi/i-have-adhd-cn/pull/60)).
...
Hoặc xóa cả tap bằng `hermes skills tap remove aixinwudi/i-have-adhd-cn`.
...
1. Chạy `/plugins`.
2. Chọn **Custom**.
3. Dán `https://github.com/aixinwudi/i-have-adhd-cn` rồi nhấn Enter.
...
npx skills add aixinwudi/i-have-adhd-cn -g               # mọi dự án
